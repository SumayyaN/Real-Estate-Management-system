...
class AdminDashboardController extends Controller
{
    ...
    {
        $clients = User::where('role', 'client')->paginate(10); // Paginate clients
    ...
    {
        $propertyOwners = User::where('role', 'owner')->paginate(10); // Paginate property owners
...
{
    $requests = OwnerRequest::all(); // or with pagination: OwnerRequest::paginate(10)
